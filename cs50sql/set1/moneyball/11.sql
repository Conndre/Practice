/* 11.sql- You need a player that can get hits. Who might be the most underrated?
Find the 10 least expensive players per hit in 2001.
Return a table with three columns, one for the players’ first names, one of their last names, and one called “dollars per hit”.
